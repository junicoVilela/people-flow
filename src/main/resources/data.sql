-- ====================================================================
-- DEPARTAMENTOS (PRIMEIRO - pois são referenciados pelos cargos)
-- ====================================================================
...
-- ====================================================================
-- CARGOS (SEGUNDO - pois são referenciados pelos colaboradores)
-- ====================================================================
...
-- ====================================================================
-- USUÁRIOS (TERCEIRO - pois são referenciados pelos colaboradores)
-- ====================================================================
...
-- ====================================================================
-- COLABORADORES (QUARTO - depois de todos os outros)
-- ====================================================================
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (6, '11122233344', '111222333', '1988-03-25', 'F', '11911112222', 'Casada', 'Rua Consolação, 1500 - São Paulo/SP', 22, 3, 6800.00, '2022-08-10', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (7, '22233344455', '222333444', '1991-07-12', 'M', '11922223333', 'Solteiro', 'Av. Brigadeiro Faria Lima, 2000 - São Paulo/SP', 11, 1, 9500.00, '2021-11-05', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (8, '33344455566', '333444555', '1987-11-30', 'F', '11933334444', 'Divorciada', 'Rua Oscar Freire, 800 - São Paulo/SP', 37, 5, 6200.00, '2023-02-15', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (9, '44455566677', '444555666', '1985-04-18', 'M', '11944445555', 'Casado', 'Rua Haddock Lobo, 1200 - São Paulo/SP', 27, 4, 5800.00, '2022-12-01', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (10, '55566677788', '555666777', '1993-09-05', 'F', '11955556666', 'Solteira', 'Rua Bela Cintra, 900 - São Paulo/SP', 2, 1, 7800.00, '2023-01-20', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (11, '66677788899', '666777888', '1990-12-22', 'M', '11966667777', 'Solteiro', 'Av. Jabaquara, 1500 - São Paulo/SP', 51, 8, 5500.00, '2023-04-10', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (12, '77788899900', '777888999', '1986-06-14', 'F', '11977778888', 'Casada', 'Rua Teodoro Sampaio, 1800 - São Paulo/SP', 45, 7, 6500.00, '2022-09-15', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (13, '88899900011', '888999000', '1989-01-28', 'M', '11988889999', 'Solteiro', 'Rua Cardeal Arcoverde, 1100 - São Paulo/SP', 41, 6, 7200.00, '2023-05-08', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (14, '99900011122', '999000111', '1994-03-10', 'F', '11999990000', 'Solteira', 'Rua Harmonia, 700 - São Paulo/SP', 35, 5, 6000.00, '2023-06-12', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (15, '00011122233', '000111222', '1987-08-05', 'M', '11900011111', 'Casado', 'Rua Fradique Coutinho, 1300 - São Paulo/SP', 6, 1, 7500.00, '2022-10-20', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (16, '11122233345', '111222334', '1991-11-15', 'F', '11911112223', 'Solteira', 'Rua dos Pinheiros, 1600 - São Paulo/SP', 15, 2, 6800.00, '2023-07-01', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (17, '22233344456', '222333445', '1988-12-03', 'M', '11922223334', 'Casado', 'Rua dos Pinheiros, 1700 - São Paulo/SP', 58, 9, 6500.00, '2023-08-15', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (18, '33344455567', '333444556', '1992-05-20', 'F', '11933334445', 'Casada', 'Rua dos Carijós, 1200 - São Paulo/SP', 57, 10, 5800.00, '2023-08-15', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (19, '44455566678', '444555667', '1986-07-08', 'M', '11944445556', 'Divorciado', 'Rua dos Açores, 1000 - São Paulo/SP', 56, 6, 6500.00, '2022-12-10', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO TB_COLABORADOR (usuario_id, cpf, rg, data_nascimento, sexo, telefone, estado_civil, endereco, cargo_id, departamento_id, salario, data_admissao, status, data_criacao, data_atualizacao) 
VALUES (20, '55566677789', '555666778', '1993-02-14', 'F', '11955556667', 'Solteira', 'Rua dos Araçás, 800 - São Paulo/SP', 55, 10, 7000.00, '2023-09-01', 'ATIVO', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
